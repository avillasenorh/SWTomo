...
Link to the source code of [SAC](https://www.dropbox.com/scl/fi/ai8bub6z1px4do862io7i/sac-102.0.tar.gz?rlkey=nyzalwp4kapjttgf52h40d5ct&dl=0)
version 102.0. The compiled versions of SAC are for `x86_64` architecture, so it should be compiled for Apple Silicon.
